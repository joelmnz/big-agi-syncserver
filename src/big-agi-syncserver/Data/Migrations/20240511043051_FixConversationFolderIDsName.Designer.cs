...
namespace big_agi_syncserver.Data.Migrations
{
    ...
    [Migration("20240511043051_FixConversationFolderIDsName")]
    partial class FixConversationFolderIDsName
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("big_agi_syncserver.Data.ConversationFolder", b =>
                {
                    ...
                    b.Property<string>("ConversationIds")
                        .HasColumnType("TEXT")
                        .HasAnnotation("Relational:JsonPropertyName", "conversationIds");
